...
Future<Pizza> _$PizzaFromSupabase(
  ...
  return Pizza(
    ...
    customer: await CustomerAdapter().fromSupabase(
      data['customer'],
      provider: provider,
...
Future<Map<String, dynamic>> _$PizzaToSupabase(
  ...
  return {
    ...
    'customer': await CustomerAdapter().toSupabase(
      instance.customer,
      provider: provider,
      repository: repository,
    ),
...
Future<Pizza> _$PizzaFromSqlite(
  ...
  return Pizza(
    ...
    customer: (await repository!.getAssociation<Customer>(
      Query.where(
        'primaryKey',
        data['customer_Customer_brick_id'] as int,
        limit1: true,
      ),
    ))!.first,
...
Future<Map<String, dynamic>> _$PizzaToSqlite(
  ...
  return {
    ...
    'customer_Customer_brick_id':
        instance.customer.primaryKey ??
        await provider.upsert<Customer>(
          instance.customer,
          repository: repository,
        ),
  };
...
class PizzaAdapter extends OfflineFirstWithSupabaseAdapter<Pizza> {
  ...
  }) async => await _$PizzaFromSupabase(
    input,
    provider: provider,
    repository: repository,
  );
