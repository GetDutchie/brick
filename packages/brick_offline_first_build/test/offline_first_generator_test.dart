  ...
  group('OfflineFirstJsonGenerators', () {
    group('constructor arguments', () {
      test('repositoryName', () async {
        ...
        await generateAdapterExpectation(
            'constructor_arguments', constructorArguments.repositoryNameAdapterExpectation,
            generator: generator);
      });
      ...
      test('superAdapterName', () async {
        ...
        await generateAdapterExpectation(
            'constructor_arguments', constructorArguments.superAdapterNameAdapterExpectation,
            generator: generator);
      });
    });
    ...
    group('#generate', () {
      ...
      test('OfflineFirstSerdesWithTypeArgument', () async {
        await generateAdapterExpectation(
            'offlne_first_serdes_with_type_argument', oflineFirstSerdesWithTypeArgument.output);
      });
    });
