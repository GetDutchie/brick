...
Future<EagerLoad> _$EagerLoadFromRest(Map<String, dynamic> data,
    {RestProvider provider, OfflineFirstRepository repository}) async {
  return EagerLoad(
...
Future<Map<String, dynamic>> _$EagerLoadToRest(EagerLoad instance,
    {RestProvider provider, OfflineFirstRepository repository}) async {
  return {
...
Future<EagerLoad> _$EagerLoadFromSqlite(Map<String, dynamic> data,
    {SqliteProvider provider, OfflineFirstRepository repository}) async {
  return EagerLoad(
...
Future<Map<String, dynamic>> _$EagerLoadToSqlite(EagerLoad instance,
    {SqliteProvider provider, OfflineFirstRepository repository}) async {
  return {
    'string': instance.string,
