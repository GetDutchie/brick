...
import 'package:brick_rest_generators/rest_generator.dart';
...
class OfflineFirstRestGenerator extends RestGenerator {
  OfflineFirstRestGenerator(Element element, ConstantReader reader, {String repositoryName})
