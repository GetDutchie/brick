...
class Where extends WhereCondition {
  ...
  Where isExactly(value) =>
      Where(evaluatedField, value: value, compare: Compare.exact, isRequired: isRequired);

  Where isBetween(value1, value2) {
