...
part '20240824214217.migration.dart';
...
final schema = Schema(20240824214217, generatorVersion: 1, tables: <SchemaTable>{
  ...
  SchemaTable('_brick_KitchenSink_list_offline_first_serdes', columns: <SchemaColumn>{
    SchemaColumn('_brick_id', Column.integer,
        autoincrement: true, nullable: false, isPrimaryKey: true),
    SchemaColumn('l_KitchenSink_brick_id', Column.integer,
        isForeignKey: true,
        ...
        onDeleteCascade: true,
        onDeleteSetDefault: false),
    SchemaColumn('f_Hat_brick_id', Column.integer,
        isForeignKey: true,
        foreignTableName: 'Hat',
        onDeleteCascade: true,
        onDeleteSetDefault: false)
  }, indices: <SchemaIndex>{
    SchemaIndex(columns: ['l_KitchenSink_brick_id', 'f_Hat_brick_id'], unique: true)
  }),
  SchemaTable('_brick_KitchenSink_set_offline_first_serdes', columns: <SchemaColumn>{
    SchemaColumn('_brick_id', Column.integer,
        autoincrement: true, nullable: false, isPrimaryKey: true),
    SchemaColumn('l_KitchenSink_brick_id', Column.integer,
        isForeignKey: true,
  ...
  SchemaTable('KitchenSink', columns: <SchemaColumn>{
    ...
    SchemaColumn('offline_first_model_Mounty_brick_id', Column.integer,
        ...
        onDeleteSetDefault: false),
    SchemaColumn('offline_first_serdes_Hat_brick_id', Column.integer,
        isForeignKey: true,
        foreignTableName: 'Hat',
        onDeleteCascade: false,
        onDeleteSetDefault: false),
  ...
  SchemaTable('Mounty', columns: <SchemaColumn>{
    ...
    SchemaColumn('hat_Hat_brick_id', Column.integer,
        isForeignKey: true,
        foreignTableName: 'Hat',
        onDeleteCascade: false,
        onDeleteSetDefault: false)
